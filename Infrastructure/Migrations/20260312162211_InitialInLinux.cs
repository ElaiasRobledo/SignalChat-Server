...
{
    /// <inheritdoc />
    public partial class InitialInLinux : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPublicName = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChannelMemberChannelId = table.Column<Guid>(type: "uuid", nullable: true),
                    ChannelMemberUserId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChannelMembers", x => new { x.ChannelId, x.UserId });
                    table.ForeignKey(
                        name: "FK_ChannelMembers_ChannelMembers_ChannelMemberChannelId_Channe~",
                        columns: x => new { x.ChannelMemberChannelId, x.ChannelMemberUserId },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Contacts", x => new { x.RequesterId, x.AddresseeId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChannelMembers_ChannelMemberChannelId_ChannelMemberUserId",
                table: "ChannelMembers",
                columns: new[] { "ChannelMemberChannelId", "ChannelMemberUserId" });
